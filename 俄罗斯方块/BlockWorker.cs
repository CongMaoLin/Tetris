...
namespace 俄罗斯方块
{
    internal class BlockWorker : IDraw
    {
       ...
       //用来判断能不能转向
        ...
        {
            DrawObject recordFirstBlock = new DrawObject(blocks[0][0].figureType, blocks[0][0].positon.x, blocks[0][0].positon.y); 
